var app = (function () {
    ...
    /* src\componnets\Space.svelte generated by Svelte v3.23.2 */
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			t = text(/*space*/ ctx[0]);
    			attr(div, "class", "space svelte-awu3m5");
    ...
    const connect = () => {
        try {
            if (!connection || connection.readyState >= 2) {
                connection = new WebSocket({"env":{"apiUrl":"https://github.tictactoe.com","wsUrl":"wss://github.tictactoe.com/ws"}}.env.wsUrl);
    ...
    const nextMove = async space => {
        try {
            const response = await fetch(`${{"env":{"apiUrl":"https://github.tictactoe.com","wsUrl":"wss://github.tictactoe.com/ws"}}.env.apiUrl}/next-turn/${space}`);
    ...
    const reset = async () => {
        try {
            await fetch(`${{"env":{"apiUrl":"https://github.tictactoe.com","wsUrl":"wss://github.tictactoe.com/ws"}}.env.apiUrl}/reset`);
        } catch (e) {
            console.log(e);
            return 'Error connection to the server';
        }
    ...
    function create_if_block_1(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(button, "class", "svelte-14f7ggv");
    		},
    		m(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(p, "class", "error-message svelte-14f7ggv");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
    			main = element("main");
    			h1 = element("h1");
    			h1.textContent = "Tic Tak Toe";
    			t1 = space();
    			h2 = element("h2");
    			t2 = text("Number of people playing: ");
    			t3 = text(/*numberOfPeople*/ ctx[3]);
    			t4 = space();
    			if_block0.c();
    			t5 = space();
    			div = element("div");
    			...
    			attr(div, "class", "game-board svelte-14f7ggv");
    			attr(main, "class", "svelte-14f7ggv");
    		},
    		m(target, anchor) {
    			...
    			append(main, t5);
    			append(main, div);
    			mount_component(space0, div, null);
    			append(div, t6);
    			mount_component(space1, div, null);
    			append(div, t7);
    			mount_component(space2, div, null);
    			append(div, t8);
    			mount_component(space3, div, null);
    			append(div, t9);
    			mount_component(space4, div, null);
    			append(div, t10);
    			mount_component(space5, div, null);
    			append(div, t11);
    			mount_component(space6, div, null);
    			append(div, t12);
    			mount_component(space7, div, null);
    			append(div, t13);
    			mount_component(space8, div, null);
    			append(main, t14);
    		...
    		p(ctx, [dirty]) {
    			if (!current || dirty & /*numberOfPeople*/ 8) set_data(t3, /*numberOfPeople*/ ctx[3]);
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	gameStore.subscribe(data => {
    		...
    		$$invalidate(3, numberOfPeople = data.numberOfPeeps);
    	});
